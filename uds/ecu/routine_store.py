...
class RoutineStore:
    ...
    def _load_config(self):
        try:
            ...
            # Fallback
            self.routines = {
                0xFF00: {"name": "Erase Memory", "status": RoutineStatus.INACTIVE, "results": b"\x00", "sessions": [0x02]},
                0xFF01: {"name": "Check Dependencies", "status": RoutineStatus.INACTIVE, "results": b"\x01", "sessions": [0x02, 0x03]},
            }

    def start_routine(self, rid: int, current_session: int, params: bytes = b"") -> tuple[bool, bytes, int]:
        """
